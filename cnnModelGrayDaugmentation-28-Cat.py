...
output_path = f"/content/drive/MyDrive/IA_proyect/output/grayscale_augmentation/1_model_28_categories/"
...
for fruit in fruits:
  ...
  for category in categories:
    ...
    for img_name in files_images:
      ...
      image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY) # Transforming the image to grayscale
      image = image.reshape(image_size, image_size, 1) # Changing shape to 128, 128, 1
