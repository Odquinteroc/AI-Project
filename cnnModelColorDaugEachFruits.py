...
for fruit in fruits:
  ...
  output_path = f"/content/drive/MyDrive/IA_proyect/output/augmentation/{fruit}/"
  ...
  plt.legend()
  plt.savefig(f"{output_path}loss_plot_{fruit}.png")
  ...
  results_df = pd.DataFrame(
      [
          {"Fruit": fruits[0],"Label_value 0":categories[0],"Label_value 1":categories[1], "TP": TP_test, "FP": FP_test, "FN": FN_test, "TN": TN_test, "Dataset": "Test", "Label Positive":1, "Label Negative":0},
          {"Fruit": fruits[0],"Label_value 0":categories[0],"Label_value 1":categories[1], "TP": TP_train, "FP": FP_train, "FN": FN_train, "TN": TN_train, "Dataset": "Train", "Label Positive":1, "Label Negative":0}
      ]
  )
